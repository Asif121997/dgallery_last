...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-2 col-md-4 col-6">
                        <a href="{{route('homepage')}}" class="logo-site">
                            <img src="{{asset('site/images/logo/logo_diamond.svg')}}" alt="">
        ...
        @yield('content')
        <!-- Footer -->
        <footer class="tf-footer bg-white">
                                ...
                                <div class="footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        <ul class="footer-menu-list mb-24">
                                            ...
                                            <li><a href="#" class="text-main-4 link">Find a location nearest you.</a></li>
                                            <li><a href="#" class="text-main-4 link text-decoration-underline">See Our Stores</a></li>
                                            <li><a href="#" class="text-main-4 link">(64) 8344 1233</a></li>
                                            <li><a href="#" class="text-main-4 link">hello@vemus.com</a></li>
                                        </ul>
                                ...
                                <div class="footer-col-block p-xl-0">
                                    ...
                                    <div class="tf-collapse-content">
                                        <ul class="footer-menu-list">
                                            ...
                                            <li><a href="#" class="text-main-4 link">Shipping</a></li>
                                            <li><a href="#" class="text-main-4 link">Returns</a></li>
                                            <li><a href="#" class="text-main-4 link">Privacy Policy</a></li>
                                            <li><a href="#" class="text-main-4 link">My Wishlist</a></li>
                                            <li><a href="#" class="text-main-4 link">Compare</a></li>
                                            <li><a href="#" class="text-main-4 link">FAQ’s</a></li>
                                ...
                                <div class="footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        <ul class="footer-menu-list">
                                            ...
                                            <li><a href="#" class="text-main-4 link">Our Story</a></li>
                                            <li><a href="#" class="text-main-4 link">Visit Our Store</a></li>
                                            <li><a href="#" class="text-main-4 link">Contact Us</a></li>
                                            <li><a href="#" class="text-main-4 link">Account</a></li>
    ...
    <script src="{{asset('site/js/photoswipe-lightbox.umd.min.js')}}"></script>
    <script src="{{asset('site/js/photoswipe.umd.min.js')}}"></script>
...
<!-- Mirrored from themesflat.co/html/vemus/product-inner-zoom.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Mar 2026 11:57:23 GMT -->
