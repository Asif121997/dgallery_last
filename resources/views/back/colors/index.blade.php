                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <a href="{{route('colors.create')}}" class="btn btn-success btn-label">
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$row->colorTranslations->where('locale','en')->first()->name}}</td>

                                                        <td>
                                                            <div style="background:{{$row->color_code}}" class="color-block">
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('colors.edit', ['color' => $row->id]) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
