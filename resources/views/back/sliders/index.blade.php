                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <a href="{{route('sliders.create')}}" class="btn btn-success btn-label">
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img width="100" src="{{asset('storage/sliders/'.$row->img)}}">
                                                        </td>

                                                        <td>
                                                            {{$row->sliderTranslations->where('locale','en')->first()->title}}
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('sliders.edit', ['slider' => $row->id]) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.toggle-status').change(function () {
                ...
                $.ajax({
                    url: '{{route("sliders.statusChange")}}',
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        status: status,
