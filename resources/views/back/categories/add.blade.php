                                                    ...
                                                    <div class="tab-content text-muted">
                                                        ...
                                                        <div class="tab-pane active" id="english" role="tabpanel">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        <label for="banner_text" class="form-label">Banner Text(English)</label>
                                                                        <input type="text" class="form-control" placeholder="Banner Text" id="banner_text" name="banner_text[]" value="">
                                                                    </div>
                                                                </div>

                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        <label for="banner_discount_text" class="form-label">Banner Discount Text(English)</label>
                                                                        <input type="text" class="form-control" placeholder="Banner Discount Text" id="banner_discount_text" name="banner_discount_text[]" value="">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="tab-pane" id="russian" role="tabpanel">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        <label for="banner_text" class="form-label">Banner Text(Russian)</label>
                                                                        <input type="text" class="form-control" placeholder="Banner Text" id="banner_text" name="banner_text[]" value="">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        <label for="banner_discount_text" class="form-label">Banner Discount Text(Russian)</label>
                                                                        <input type="text" class="form-control" placeholder="Banner Discount Text" id="banner_discount_text" name="banner_discount_text[]" value="">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="tab-pane" id="arabic" role="tabpanel">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        <label for="banner_text" class="form-label">Banner Text(Azerbaijani)</label>
                                                                        <input type="text" class="form-control" placeholder="Banner Text" id="banner_text" name="banner_text[]" value="">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        <label for="banner_discount_text" class="form-label">Banner Discount Text(Azerbaijani)</label>
                                                                        <input type="text" class="form-control" placeholder="Banner Discount Text" id="banner_discount_text" name="banner_discount_text[]" value="">
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="file" class="form-control" id="icon_image" name="icon_image" value="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div>
                                                            ...
                                                            <div class="form-check form-switch mb-3">
                                                                <input class="form-check-input" type="checkbox" role="switch" id="show_home"  name="show_home">
