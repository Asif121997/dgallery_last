                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <a href="{{route('sizes.create')}}" class="btn btn-success btn-label">
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$row->name}}</td>
                                                        <td>{{@$row->category->categoryTranslations->where('locale','en')->first()->name}}</td>
                                                        
                                                        
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('sizes.edit', ['size' => $row->id]) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
