                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Size Create</h4>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" name="category_id">
                                                                @foreach($categories as $category)
                                                                    <option @if($category->id == $size->category_id) selected @endif value="{{$category->id}}">{{$category->categoryTranslations->where('locale','en')->first()->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
