                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Review List</h4>
                                    <a href="{{route('reviews.create')}}" class="btn btn-success btn-label">
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$row->reviewTranslations->where('locale','en')->first()->name}}</td>
                                                        
                                                        
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                
                                                                <form action="{{ route('reviews.destroy', $row->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
