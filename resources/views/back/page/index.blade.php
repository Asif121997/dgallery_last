                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <a href="{{route('pages.create')}}" class="btn btn-success btn-label">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img width="100" src="{{asset('storage/pages/'.$row->img)}}">
                                                        </td>
                                                        <td>{{$row->pageTranslations->where('locale','az')->first()->name}}</td>
                                                        
                                                        
                                                        <td>{{$row->type}}</td>
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('pages.edit', ['page' => $row->id]) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
