                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Option Create</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Option Create</h4>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control" name="option_group_id">
                                                            @foreach($optionGroups as $optionGroup)
                                                                <option value="{{$optionGroup->id}}">{{$optionGroup->optionGroupTranslations->where('locale','en')->first()->name}}</option>
