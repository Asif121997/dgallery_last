                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <a href="{{route('brands.create')}}" class="btn btn-success btn-label">
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img width="100" src="{{asset('storage/brands/'.$row->img)}}">
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('brands.edit', ['brand' => $row->id]) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
