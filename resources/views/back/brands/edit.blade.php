                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <img width="100" src="{{asset('storage/brands/'.$brand->img)}}">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div>
                                                            ...
                                                            <div class="form-check form-switch mb-3">
                                                                <input class="form-check-input" type="checkbox" role="switch" id="SwitchCheck"  name="status" @if($brand->status == 1)  checked @endif>  
