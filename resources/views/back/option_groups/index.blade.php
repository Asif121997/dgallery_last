                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Option Group List</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Option Group List</h4>
                                    <a href="{{route('option_groups.create')}}" class="btn btn-success btn-label">
                                            ...
                                            <table  id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr  data-id="{{ $row->id }}">
                                                        ...
                                                        <td>{{$row->optionGroupTranslations->where('locale','en')->first()->name}}</td>
                                                        

                                                       
                                                        <td>
                                                           
                                                                <a href="{{route('option_groups.options',['option_group' => $row->id])}}" class="btn btn-success">Options</a>
                                                            
                                                        </td>
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('option_groups.edit', ['option_group' => $row->id]) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
                                                                <form action="{{ route('option_groups.destroy', $row->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
        ...
        $("#example tbody").sortable({
            update: function (event, ui) {
                // Get the new row order
                    ...
                    $.ajax({
                        url: "{{ route('datatable.updateOrderOptionGroups') }}",
                        type: "GET",
                        data: {
                            order: newOrder,
                        }
