                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Blog Tags</a></li>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Blog Tag List</h4>
                                    <a href="{{route('blogTags.create')}}" class="btn btn-success btn-label">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('blogTags.edit', ['blogTag' => $row->id]) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
                                                                <form action="{{ route('blogTags.destroy', $row->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
