                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <a href="{{route('blogs.create')}}" class="btn btn-success btn-label">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img width="100" src="{{asset('storage/blogs/'.$row->img)}}">
                                                        </td>
                                                        <td>{{$row->blogTranslations->where('locale','en')->first()->name}}</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('blogs.edit', ['blog' => $row->id]) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
