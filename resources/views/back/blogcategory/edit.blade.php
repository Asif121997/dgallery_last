                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Blog Category Edit</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form action="{{ route('blogCategory.update',['blogCategory'=>$blogCategory->id]) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PATCH')
                                            <div class="row">
                                                <div class="col-md-6">
