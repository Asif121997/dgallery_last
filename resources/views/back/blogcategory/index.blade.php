                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Blog Category List</h4>
                                    <a href="{{route('blogCategory.create')}}" class="btn btn-success btn-label">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('blogCategory.edit', ['blogCategory' => $row->id]) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
                                                                <form action="{{ route('blogCategory.destroy', $row->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
