                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Redirect List</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Redirect List</h4>
                                    <a href="{{route('redirects.create')}}" class="btn btn-success btn-label">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="{{ route('redirects.edit', ['redirect' => $row->id]) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
                                                                <form action="{{ route('redirects.destroy', $row->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
