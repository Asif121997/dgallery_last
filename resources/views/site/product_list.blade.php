                ...
                <div class="swiper tf-swiper" data-preview="5" data-tablet="4" data-mobile-sm="3" data-mobile="2" data-space-lg="30"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="box_collection--V01 style_2 hover-img">
                                <a href="shop-default.html" class="image img-style">
                                    <img src="{{asset('site/images/collections/cls-13.jpg')}}" data-src="{{asset('site/images/collections/cls-13.jpg')}}" alt="" class=" lazyload">
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="box_collection--V01 style_2 hover-img">
                                <a href="shop-default.html" class="image img-style">
                                    <img src="{{asset('site/images/collections/cls-14.jpg')}}" data-src="{{asset('site/images/collections/cls-14.jpg')}}" alt="" class=" lazyload">
                                </a>
                                <a href="shop-default.html" class="name-cls link">
                                    <span class="h5 fw-normal text-uppercase">
                                        tennis
                        ...
                        <div class="swiper-slide">
                            <div class="box_collection--V01 style_2 hover-img">
                                <a href="shop-default.html" class="image img-style">
                                    <img src="{{asset('site/images/collections/cls-15.jpg')}}" data-src="{{asset('site/images/collections/cls-15.jpg')}}" alt="" class=" lazyload">
                                </a>
                                <a href="shop-default.html" class="name-cls link">
                                    <span class="h5 fw-normal text-uppercase">
                                        stacking
                        ...
                        <div class="swiper-slide">
                            <div class="box_collection--V01 style_2 hover-img">
                                <a href="shop-default.html" class="image img-style">
                                    <img src="{{asset('site/images/collections/cls-16.jpg')}}" data-src="{{asset('site/images/collections/cls-16.jpg')}}" alt="" class=" lazyload">
                                </a>
                                <a href="shop-default.html" class="name-cls link">
                                    <span class="h5 fw-normal text-uppercase">
                                        cuff
                        ...
                        <div class="swiper-slide">
                            <div class="box_collection--V01 style_2 hover-img">
                                <a href="shop-default.html" class="image img-style">
                                    <img src="{{asset('site/images/collections/cls-17.jpg')}}" data-src="{{asset('site/images/collections/cls-17.jpg')}}" alt="" class=" lazyload">
                                </a>
                                <a href="shop-default.html" class="name-cls link">
                                    <span class="h5 fw-normal text-uppercase">
                                        chain
            ...
            <div class="container">
                <div class="tf-shop-control">
                    <div class="tf-control-filter">
                        <a href="#filterShop" data-bs-toggle="offcanvas" class="tf-btn-filter h4 link">
                    ...
                    <div class="tf-group-layout">
                        <ul class="tf-control-layout">
                            ...
                            <li class="tf-view-layout-switch sw-layout-4 active d-none d-xl-flex" data-value-layout="tf-col-4">
                ...
                <div class="wrapper-control-shop gridLayout-wrapper">
                    <div class="wrapper-shop tf-grid-layout tf-col-4" id="gridLayout">
                        <!-- Product 1 -->
                        <div class="loadItem card_product--V01 grid" data-availability="In stock" data-category="ring" data-material="sterling-silver"
                            data-size="6">
                            <div class="card_product-wrapper">
                                <a href="product-default.html" class="product-img">
                                    <img src="{{asset('site/images/products/product-1.jpg')}}" data-src="{{asset('site/images/products/product-1.jpg')}}" alt="Image Product"
                                        class="lazyload img-product">
                                    <img src="{{asset('site/images/products/product-12.jpg')}}" data-src="{{asset('site/images/products/product-12.jpg')}}" alt="Image Product"
                        ...
                        <!-- Product 2 -->
                        <div class="loadItem card_product--V01 grid" data-availability="In stock" data-category="bracelet" data-material="white-gold"
                            data-size="5">
                            <div class="card_product-wrapper">
                                <a href="product-default.html" class="product-img">
                                    <img src="{{asset('site/images/products/product-2.jpg')}}" data-src="{{asset('site/images/products/product-2.jpg')}}" alt="Image Product"
                                        class="lazyload img-product">
                                    <img src="{{asset('site/images/products/product-13.jpg')}}" data-src="{{asset('site/images/products/product-13.jpg')}}" alt="Image Product"
                                        class="lazyload img-hover">
                                </a>
                                <ul class="list-product-btn">
                                    <li class="wishlist">
                        ...
                        <div class="loadItem card_product--V01 grid" data-availability="In stock" data-category="bracelet"
                            ...
                            <div class="card_product-wrapper">
                                <a href="product-default.html" class="product-img">
                                    <img src="{{asset('site/images/products/product-3.jpg')}}" data-src="{{asset('site/images/products/product-3.jpg')}}" alt="Image Product"
                                        class="lazyload img-product">
                                    <img src="{{asset('site/images/products/product-14.jpg')}}" data-src="{{asset('site/images/products/product-14.jpg')}}" alt="Image Product"
                                        class="lazyload img-hover">
                                </a>
                                <ul class="list-product-btn">
                                    <li class="wishlist">
                        ...
                        <div class="loadItem card_product--V01 grid out-of-stock" data-availability="Out of stock" data-category="bracelet"
                            ...
                            <div class="card_product-wrapper">
                                <a href="product-notify-avaiable.html" class="product-img">
                                    <img src="{{asset('site/images/products/product-4.jpg')}}" data-src="{{asset('site/images/products/product-4.jpg')}}" alt="Image Product"
                                        class="lazyload img-product">
                                    <img src="{{asset('site/images/products/product-15.jpg')}}" data-src="{{asset('site/images/products/product-15.jpg')}}" alt="Image Product"
                                        class="lazyload img-hover">
                                </a>
                        ...
                        <div class="loadItem tempo box_image--V02 hover-img">
                            <a href="shop-collection-list.html" class="box_image-image img-style">
                                <img src="{{asset('site/images/collections/discover-1.jpg')}}" data-src="{{asset('site/images/collections/discover-1.jpg')}}" alt="" class="lazyload">
                            </a>
                            <div class="box_image-content align-items-center text-center">
                                <a href="shop-collection-list.html" class="title h3 fw-normal font-2 text-white link-secondary">
                                    <span class="fst-italic">Diamond</span> For All
                                </a>
                                <a href="shop-collection-list.html" class="tf-btn style-3 btn-fill-white animate-btn animate-dark">
                        ...
                        <div class=" loadItem card_product--V01 grid" data-availability="In stock" data-category="bracelet"
                            ...
                            <div class="card_product-wrapper">
                                <a href="product-default.html" class="product-img">
                                    <img src="{{asset('site/images/products/product-16.jpg')}}" data-src="{{asset('site/images/products/product-16.jpg')}}" alt="Image Product"
                                        class="lazyload img-product">
                                    <img src="{{asset('site/images/products/product-17.jpg')}}" data-src="{{asset('site/images/products/product-17.jpg')}}" alt="Image Product"
                                        class="lazyload img-hover">
                                </a>
                                <ul class="list-product-btn">
                                    <li class="wishlist">
                        ...
                        <div class="loadItem card_product--V01 grid" data-availability="In stock" data-category="ring" data-material="sterling-silver"
                            ...
                            <div class="card_product-wrapper">
                                <a href="product-default.html" class="product-img">
                                    <img src="{{asset('site/images/products/product-18.jpg')}}" data-src="{{asset('site/images/products/product-18.jpg')}}" alt="Image Product"
                                        class="lazyload img-product">
                                    <img src="{{asset('site/images/products/product-19.jpg')}}" data-src="{{asset('site/images/products/product-19.jpg')}}" alt="Image Product"
                                        class="lazyload img-hover">
                                </a>
                                <ul class="list-product-btn">
                                    <li class="wishlist">
                        ...
                        <!-- Product 8 -->
                        <div class="loadItem card_product--V01 grid" data-availability="In stock" data-category="bracelet" data-material="gold"
                            data-size="9">
                            <div class="card_product-wrapper">
                                <a href="product-default.html" class="product-img">
                                    <img src="{{asset('site/images/products/product-20.jpg')}}" data-src="{{asset('site/images/products/product-20.jpg')}}" alt="Image Product"
                                        class="lazyload img-product">
                                    <img src="{{asset('site/images/products/product-21.jpg')}}" data-src="{{asset('site/images/products/product-21.jpg')}}" alt="Image Product"
                                        class="lazyload img-hover">
                                </a>
                                <ul class="list-product-btn">
                                    <li class="wishlist">
                        ...
                        <div class="loadItem card_product--V01 grid" data-availability="In stock" data-category="bracelet"
                            ...
                            <div class="card_product-wrapper">
                                <a href="product-default.html" class="product-img">
                                    <img src="{{asset('site/images/products/product-22.jpg')}}" data-src="{{asset('site/images/products/product-22.jpg')}}" alt="Image Product"
                                        class="lazyload img-product">
                                    <img src="{{asset('site/images/products/product-23.jpg')}}" data-src="{{asset('site/images/products/product-23.jpg')}}" alt="Image Product"
                                        class="lazyload img-hover">
                                </a>
                                <ul class="list-product-btn">
                                    <li class="wishlist">
                        ...
                        <!-- Product 12 -->
                        <div class="loadItem card_product--V01 grid" data-availability="In stock" data-category="ring" data-material="pink-gold"
                            data-size="6">
                            <div class="card_product-wrapper">
                                <a href="product-default.html" class="product-img">
                        ...
                        <div class="loadItem card_product--V01 grid" data-availability="In stock" data-category="bracelet" data-material="white-gold"
                            ...
                            <div class="card_product-wrapper">
                                <a href="product-default.html" class="product-img">
                                    <img src="{{asset('site/images/products/product-30.jpg')}}" data-src="{{asset('site/images/products/product-30.jpg')}}" alt="Image Product"
                                        class="lazyload img-product">
                                    <img src="{{asset('site/images/products/product-31.jpg')}}" data-src="{{asset('site/images/products/product-31.jpg')}}" alt="Image Product"
                                        class="lazyload img-hover">
                                </a>
                                <ul class="list-product-btn">
                                    <li class="wishlist">
                        ...
                        <div class="loadItem card_product--V01 grid" data-availability="In stock" data-category="bracelet" data-material="gold"
                            ...
                            <div class="card_product-wrapper">
                                <a href="product-default.html" class="product-img">
                                    <img src="{{asset('site/images/products/product-32.jpg')}}" data-src="{{asset('site/images/products/product-32.jpg')}}" alt="Image Product"
                                        class="lazyload img-product">
                                    <img src="{{asset('site/images/products/product-33.jpg')}}" data-src="{{asset('site/images/products/product-33.jpg')}}" alt="Image Product"
                                        class="lazyload img-hover">
                                </a>
                                <ul class="list-product-btn">
                                    <li class="wishlist">
                        ...
                        <!-- Product 15 16 -->
                        <div class="loadItem tempo wd-2-cols box_image--V02 style-2 hover-img">
                            <a href="shop-collection-list.html" class="box_image-image img-style">
                                <img src="{{asset('site/images/collections/discover-2.jpg')}}" data-src="{{asset('site/images/collections/discover-2.jpg')}}" alt="" class="lazyload">
                            </a>
                            <div class="box_image-content type-left">
                                <div class="heading">
                                    <p class="fw-medium text-white text-uppercase">be love</p>
                                    <a href="shop-collection-list.html" class="title h2 fw-normal font-2 text-white link link-secondary">
            ...
            <div class="container">
                <div class="tf-swiper swiper sw-iconbox" data-preview="4" data-tablet="3" data-mobile-sm="2" data-mobile="1" data-space-lg="80"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <!-- item 2 -->
                        <div class="swiper-slide">
                            <div class="box_icon--V01 style-white" data-wow-delay="0.1s">
                                <span class="icon">
                        ...
                        <!-- item 3 -->
                        <div class="swiper-slide">
                            <div class="box_icon--V01 style-white" data-wow-delay="0.2s">
                                <span class="icon">
                        ...
                        <!-- item 4 -->
                        <div class="swiper-slide">
                            <div class="box_icon--V01 style-white" data-wow-delay="0.3s">
                                <span class="icon">
